...
def create_user(user_data):
    ...
    :return: user.id
    """
    print('-------------------- user-views: create_user')
    print('user_data: ', user_data)
    new_user = UserMethod.create_user(authenticated=user_data['authenticated'],
    ...
    user = UserMethod.get_id_by_email(user_email=user_data['email'])
    if user:
        return user.id
    else:
